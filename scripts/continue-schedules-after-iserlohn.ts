// Continue schedule sync from after Iserlohn onward
...
async function continueScheduleSync() {
  console.log('🔄 Continuing schedule sync from after Iserlohn...\n');
  ...
  console.log(`Found ${teams.length} teams to sync (after Iserlohn)\n`);
